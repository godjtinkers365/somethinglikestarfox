...
export class Wingnose2 {
    ...
    public render(scene){
        this.nose = MeshBuilder.CreateCylinder("nose",{
            ...
            diameterTop:        1, //(number) diameter of the top cap, can be zero to create a cone, overwrites the diameter option	1
            diameterBottom: 	1.6, //(number) diameter of the bottom cap, can't be zero, overwrites the diameter option	1
        ...
        this.nosetip = MeshBuilder.CreateCylinder("nosetip",{
            height:             1, //(number) height of the cylinder	2
