...
import { Wingnose } from "./wingnose";
export class Wingnose0 extends Wingnose {
    nose;
    constructor({}){
        super({})
    }
    public render(scene){
        this.nose = MeshBuilder.CreateCylinder("nose",{
            ...
            diameterBottom: 	3, //(number) diameter of the bottom cap, can't be zero, overwrites the diameter option	1
            diameter:           1,//(number) diameter of both caps	1
            tessellation:	    4,//(number) number of radial sides	24
